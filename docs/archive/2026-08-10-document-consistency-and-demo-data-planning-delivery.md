...
- DATA-001 当时加入热层 BACKLOG，并新增本机与面试演示数据计划；该计划完成后已转为[本机与面试演示数据交付记录](2026-08-11-demo-data-delivery.md)。最初范围只包括约 12～20 本公版书籍、库存、规格、仓库内本地图片和广告，随后经项目所有者确认扩展为少量公版书籍、确定性虚构书籍和本地演示账户。
